...
export default function Footer() {
    return (
        <footer className="border-t border-black/5 bg-gray-50 pt-16 pb-12">
            <div className="px-6 mx-auto max-w-7xl">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    {/* Product */}
                    <div>
                        <h3 className="font-semibold text-supermock-text mb-6">Product</h3>
                        <ul className="space-y-4 text-supermock-text-secondary">
                            <li><Link href="#pricing" className="hover:text-supermock-text transition-colors">Pricing</Link></li>
                            <li><Link href="#features" className="hover:text-supermock-text transition-colors">Features</Link></li>
                            <li><Link href="#" className="hover:text-supermock-text transition-colors">Testimonials</Link></li>
                            <li><Link href="#" className="hover:text-supermock-text transition-colors">API Access</Link></li>
                        </ul>
                    </div>

                    {/* Legal */}
                    <div>
                        <h3 className="font-semibold text-supermock-text mb-6">Legal</h3>
                        <ul className="space-y-4 text-supermock-text-secondary">
                            <li><Link href="#" className="hover:text-supermock-text transition-colors">Terms of Service</Link></li>
                            <li><Link href="#" className="hover:text-supermock-text transition-colors">Privacy Policy</Link></li>
                            <li><Link href="#" className="hover:text-supermock-text transition-colors">Cookie Policy</Link></li>
                            <li><Link href="#" className="hover:text-supermock-text transition-colors">Security</Link></li>
                        </ul>
                    </div>

                    {/* Contact */}
                    <div>
                        <h3 className="font-semibold text-supermock-text mb-6">Contact</h3>
                        <ul className="space-y-4 text-supermock-text-secondary">
