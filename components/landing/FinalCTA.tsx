    ...
    <section className="relative px-4 md:px-8 py-14 sm:py-16 md:py-20 lg:py-28 overflow-hidden text-center bg-gray-50">
      <div className="relative z-10 max-w-5xl mx-auto space-y-8 md:space-y-12">
        ...
        <div className="pt-2 md:pt-4 flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 w-full max-w-md sm:max-w-none mx-auto">
          ...
          {/* WhatsApp Button */}
          <button className="w-full sm:w-auto group relative px-6 py-3 md:px-8 md:py-4 text-base md:text-lg font-bold text-[#25D366] bg-white border border-[#25D366]/20 rounded-xl md:rounded-full hover:scale-[1.01] hover:shadow-lg transition-all shadow-md group/whatsapp flex items-center justify-center gap-2 md:gap-3">
            <svg
