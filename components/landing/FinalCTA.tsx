        ...
        <section className="relative px-6 py-32 overflow-hidden text-center bg-gray-50">
            ...
            <div className="relative z-10 max-w-5xl mx-auto space-y-12">
                ...
                <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-6">
                    <Link href="/register" className="group relative px-10 py-5 text-xl font-bold text-white transition-all transform rounded-full shadow-2xl hover:scale-105 hover:-translate-y-1 overflow-hidden">
